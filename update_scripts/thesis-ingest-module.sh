...
cd ~/hasob/tetfund-thesis-digitilization-ingest-module
...
INPUT_DIR_1="./tetfund-thesis-digitilization-ingest-module"
OUTPUT_TAR_DIR_1="tetfund-thesis-digitilization-ingest-module.tar.gz"
