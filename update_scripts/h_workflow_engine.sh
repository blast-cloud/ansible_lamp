...
cd ~/hasob/hasob-workflow-engine-bs-5
...
INPUT_DIR="./hasob-workflow-engine-bs-5"
OUTPUT_TAR_DIR="hasob-workflow-engine-bs-5.tar.gz"
...
# change directory 
cd ~/hasob/ansible_lamp/playbooks/workflow-engine-bs-5/
